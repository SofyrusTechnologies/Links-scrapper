...
// @ts-ignore optional peer dependency or compatibility with es2022
        body?: string | Buffer | Readable | Generator<unknown, any, any> | AsyncGenerator<unknown, any, any> | import("got-scraping/node_modules/form-data-encoder", { with: { "resolution-mode": "import" } }).FormDataLike | undefined;
        json?: unknown;
// @ts-ignore optional peer dependency or compatibility with es2022
...
// @ts-ignore optional peer dependency or compatibility with es2022
            (hostname: string, options: import("cacheable-lookup", { with: { "resolution-mode": "import" } }).LookupOptions & {
                all: true;
// @ts-ignore optional peer dependency or compatibility with es2022
            }, callback: (error: NodeJS.ErrnoException | null, result: ReadonlyArray<import("cacheable-lookup", { with: { "resolution-mode": "import" } }).EntryObject>) => void): void;
// @ts-ignore optional peer dependency or compatibility with es2022
...
// @ts-ignore optional peer dependency or compatibility with es2022
        cache?: string | boolean | import("got-scraping/node_modules/cacheable-request", { with: { "resolution-mode": "import" } }).StorageAdapter | undefined;
